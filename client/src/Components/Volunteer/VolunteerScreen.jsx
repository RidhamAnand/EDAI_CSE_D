      ...
      <div className=" flex h-full mr-4 ml-4 mt-4 flex-row gap-2">
        ...
        <div className="middle-componet gap-5 basis-full flex flex-col h-screen ">
          ...
          >
            ...
            <div className="h-10 w- flex flex-col justify-between">
              <Button
                variant="outlined"
                size="small"
                fullWidth
              ...
              >
                ...
                <div className="description">
                  <p className="font-poppins text-xs">
                    Our area has been severely flooded, and many of us are
                    stranded. We urgently need clean drinking water, food
                    supplies, and medical assistance. If anyone is available to
                    help or knows someone who can, please reach out. Every bit
                    of support counts!
                  </p>
                ...
                <div className="flex flex-row justify-between">
                  <div>
                    ...
                    <p>Flood, Medical, Infrastructure</p>
                  </div>
                ...
                <div className="flex flex-row justify-between">
                  <h1 className="font-medium">Distance: 3.5 Km</h1>
                  <h1 className="font-medium">Location: Khadakwasla</h1>
                </div>
